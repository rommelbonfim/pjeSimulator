...
public class ProfileForm implements Serializable {
    ...
    public ProfileForm(Long id, String name, String email, String period, String registrationNumber, String cpf, String password) {
        this.id = id;
        this.name = name;
        this.email = email;
        this.period = period;
    ...
    public ProfileForm(Profile entity) {
    ...
    public boolean equals(Object o) {
        ...
        ProfileForm entity = (ProfileForm) o;
